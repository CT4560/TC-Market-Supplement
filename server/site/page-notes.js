...
export async function notesPage({ config }) {
  ...
  const element = h(
    ...
    h("h2", { text: "資料從哪裡來" }),
    h("p", { text: "繁中服有一批舊染劑與色素，Universalis 沒有它們的價格資料。這裡的資料來自玩家使用 FFXIV-TW-Market-Data-Supplement 插件：玩家在市場板查看這些物品時，插件會把看到的掛單與成交紀錄匿名回報到這裡。沒有任何程式會主動去抓資料，也沒有人被要求去查價。" }),
